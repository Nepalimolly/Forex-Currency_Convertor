...
url = 'https://api.exchangerate.host/latest?places=2'
# url = f'https://api.exchangerate.host/convert?from=USD&to=EUR&amount=1000&places=2'
...
def homepage():
        if request.method == "POST":
            ...
            first_amount = data["rates"][convert_from]
            second_amount = data["rates"][convert_to]
